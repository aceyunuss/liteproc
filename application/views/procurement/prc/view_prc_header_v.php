    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <label class="col-form-label"><?= $prc_head['user_name'] ?></label>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <label class="col-form-label"><?= $prc_head['div_name'] ?></label>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <label class="col-form-label"><?= $prc_head['proc_name'] ?></label>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <label class="col-form-label"><?= $prc_head['proc_desc'] ?></label>
          </div>
        </div>
